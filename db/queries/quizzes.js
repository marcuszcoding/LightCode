...
const createQuizQuestion = function(info) {
  ...
  const createURL = () => {
    ...
    const createNewQuiz = (id, info) => {
      ...
      VALUES ($1, $2, $3, $4)
       RETURNING *;`, [id, info.title, info.public_listed, createdURL || null])
      .then(data => data.rows[0])
      .catch(err => err.message);
    };
...
module.exports = { create, getAll, getById, getByUserId, update, remove, createQuizQuestion, createQuizAnswer, createNewQuiz, getAnswersForQuiz, getAnswersForQuestion };
